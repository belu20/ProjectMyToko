...
import com.example.mytoko.ui.home.home.ProsesScrudActivity;
...
public void onBindViewHolder(@NonNull NoteAdapter.NoteViewHolder holder, int position) {
        ...
        Intent intent = new Intent(activity, ProsesScrudActivity.class);
        intent.putExtra(ProsesScrudActivity.EXTRA_POSITION, position1);
        intent.putExtra(ProsesScrudActivity.EXTRA_NOTE, listNotes.get(position1));
        activity.startActivityForResult(intent, ProsesScrudActivity.REQUEST_UPDATE);
        }));
        }
